...
<?php
	...
	$result = get_arm_data_log($cur_page, 20, $area_no, $target_player_name);
	...
	$rs = new ResultSet();
	$colname = array();
	$colname[] = "唯一id"; $colname[] = "卡片id"; $colname[] = "名称";
	$colname[] = "绑定"; $colname[] = "修炼点"; $colname[] = "当前兵力值";
	$colname[] = "基础兵力值上限"; $colname[] = "武"; $colname[] = "防";
	$colname[] = "敏"; $colname[] = "智"; $colname[] = "仁";
	$colname[] = "武Lv"; $colname[] = "防Lv";	$colname[] = "敏Lv";
	$colname[] = "智Lv"; $colname[] = "仁Lv"; $colname[] = "军功";
	$colname[] = "技能1"; $colname[] = "技能2"; $colname[] = "技能3";
	$colname[] = "官职"; $colname[] = "等级"; $colname[] = "星级";
	$colname[] = "经验"; $colname[] = "属性总和";
