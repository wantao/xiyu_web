...
$str_now_t = date('Y-m-d',time()-30*24*3600);
...
<!-- 结果显示 -->
<?php
	$result = get_gefuhuizong($str_now_t, $str_now_t1);
	...
	$rs = new ResultSet();
	$colname = array();
	$colname[] = "服务器"; $colname[] = "角色总数"; $colname[] = "同时最高在线人数";
	$colname[] = "充值人数"; $colname[] = "充值次数"; $colname[] = "充值总金额";
	$colname[] = "平均日充金额"; $colname[] = "总天数";
	$resultval = array();
	$resultval = $result;
	$rs->col = $colname;
